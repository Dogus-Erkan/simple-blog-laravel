...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('admin.page.update.post',$page->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="">Makale Başlığı</label>
                <input type="text" class="form-control" value="{{ $page->title }}" name="title" required id="">
            </div>
